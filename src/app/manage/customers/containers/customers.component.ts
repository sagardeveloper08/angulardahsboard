...
// import { CustomersModalComponent } from 'src/app/shared/components/customers-modal/customers-modal.component';
...
export class CustomersComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.customersSub = this.store.select(getCustomers).pipe(
      ...
      //  if (this.user && !customers) {    this.store.dispatch(new fromCustomers.CustomersQuery());     }
        return customers;
      })
    )
  ...
  //get user() {    return this.afAuth.auth.currentUser;  }
